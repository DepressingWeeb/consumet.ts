    ...
    constructor(provider, proxyConfig, adapter) {
        ...
        this.fetchAnimeInfo = async (id, dub = false, fetchFiller = false) => {
            ...
            try {
                ...
                animeInfo.characters = (_64 = (_63 = (_62 = (_61 = data.data) === null || _61 === void 0 ? void 0 : _61.Media) === null || _62 === void 0 ? void 0 : _62.characters) === null || _63 === void 0 ? void 0 : _63.edges) === null || _64 === void 0 ? void 0 : _64.map((item) => {
                    var _b, _c, _d;
                    return ({
                ...
                if ((this.provider instanceof zoro_1.default || this.provider instanceof gogoanime_1.default) &&
                    ...
                    try {
                        ...
                        animeInfo.episodes = (_65 = anifyInfo.episodes) === null || _65 === void 0 ? void 0 : _65.map((item) => {
                            var _b;
                            return ({
                                id: item.id,
                                title: item.title,
                        ...
                        if (!((_66 = animeInfo.episodes) === null || _66 === void 0 ? void 0 : _66.length)) {
                            animeInfo.episodes = await this.fetchDefaultEpisodeList({
                                ...
                                title: {
                                    english: (_67 = animeInfo.title) === null || _67 === void 0 ? void 0 : _67.english,
                                    romaji: (_68 = animeInfo.title) === null || _68 === void 0 ? void 0 : _68.romaji,
                                },
                            }, dub, id);
                            animeInfo.episodes = (_69 = animeInfo.episodes) === null || _69 === void 0 ? void 0 : _69.map((episode) => {
                                if (!episode.image) {
                        ...
                        animeInfo.episodes = await this.fetchDefaultEpisodeList({
                            ...
                            startDate: { year: parseInt(animeInfo.releaseDate) },
                            title: {
                                english: (_70 = animeInfo.title) === null || _70 === void 0 ? void 0 : _70.english,
                                romaji: (_71 = animeInfo.title) === null || _71 === void 0 ? void 0 : _71.romaji,
                            },
                        }, dub, id);
                        animeInfo.episodes = (_72 = animeInfo.episodes) === null || _72 === void 0 ? void 0 : _72.map((episode) => {
                            if (!episode.image) {
                                episode.image = animeInfo.image;
                                episode.imageHash = animeInfo.imageHash;
                            }
